...
void loop(void)
{
  ...
  /* Got a packet! */
  // printHex(packetbuffer, len);inline int angle_to_channel(float a) {
...
//    }
  ...
  tft.setCursor(0,25);tft.print("pitch  yaw   roll");
  tft.fillRect(0,45,300,20,ScreenColor);
  tft.setCursor(0,45);tft.print(pitch);
   tft.setCursor(70,45);tft.print(yaw);
    tft.setCursor(150,45);tft.print(roll);
  Xan = pitch;
  Yan = roll;
