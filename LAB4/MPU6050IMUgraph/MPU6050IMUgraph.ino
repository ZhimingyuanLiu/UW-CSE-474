...
*/    
  ...
  // For more see http://en.wikipedia.org/wiki/Conversion_between_quaternions_and_Euler_angles which has additional links.
    ...
    yaw   *= 180.0f / PI; 
    roll  *= 180.0f / PI;
    long  Mappedyaw = map(yaw, -200, 200, -160, 160);
    long  Mappedpitch = map(pitch, -200, 200, -160, 160);
    long  Mappedroll = map(roll, -200, 200, -160, 160);
...
//    Serial.print("average rate = "); Serial.print(1.0f/deltat, 2); Serial.println(" Hz");
    ...
    */
    ...
    // tft.setCursor(0,160); tft.print("GYRO-RATE");
     tft.setCursor(50,160); tft.print("yaw");
     tft.setCursor(110,160); tft.print("pitch");
     tft.setCursor(170,160); tft.print("row");
    ...
    if(Mappedyaw < 0){
      tft.drawRect(40, 160, 40,-Mappedyaw, 0xF81F);
      tft.fillRect(40, 160, 40,-Mappedyaw, 0xF81F);
    }else{
      tft.drawRect(40, 160-Mappedyaw, 40,Mappedyaw, 0xF81F);
      tft.fillRect(40, 160-Mappedyaw, 40,Mappedyaw, 0xF81F);
    }

    if(Mappedpitch < 0){
      tft.drawRect(100, 160, 40, -Mappedpitch, 0x07FF);
      tft.fillRect(100, 160, 40, -Mappedpitch, 0x07FF);
    }else{
      tft.drawRect(100, 160-Mappedpitch, 40, Mappedpitch, 0x07FF);
      tft.fillRect(100, 160-Mappedpitch, 40, Mappedpitch, 0x07FF);
    }

    
    if (Mappedroll < 0) {
      tft.drawRect(160, 160, 40, -Mappedroll, 0x001F);
      tft.fillRect(160, 160, 40, -Mappedroll, 0x001F);
    } else {
      tft.drawRect(160, 160-Mappedroll, 40, Mappedroll, 0x001F);
      tft.fillRect(160, 160-Mappedroll, 40, Mappedroll, 0x001F);
    }
