...
{  
  ...
  if(readByte(MPU6050_ADDRESS, INT_STATUS) & 0x01) {  // check if data ready interrupt
    ...
    Serial.print("X-acceleration: "); Serial.print(50*ax); Serial.print(" mg "); 
    Serial.print("Y-acceleration: "); Serial.print(50*ay); Serial.print(" mg "); 
    Serial.print("Z-acceleration: "); Serial.print(50*az); Serial.println(" mg"); 
   ...
   // Print temperature in degrees Centigrade      lo
   ...
   // Serial.println("");
    ...
    if(ax < 0){
      tft.drawRect(40, 80, 40,-ax*50, 0xF81F);
      tft.fillRect(40, 80, 40,-ax*50, 0xF81F);
    }else{
      tft.drawRect(40, 80-ax*50, 40,ax*50, 0xF81F);
      tft.fillRect(40, 80-ax*50, 40,ax*50, 0xF81F);
    }

    if(ay < 0){
      tft.drawRect(100, 80, 40, -ay*50, 0x07FF);
      tft.fillRect(100, 80, 40, -ay*50, 0x07FF);
    }else{
      tft.drawRect(100, 80-ay*50, 40,ay*50, 0xF81F);
      tft.fillRect(100, 80-ay*50, 40,ay*50, 0xF81F);
    }

    
    if (az < 0) {
      tft.drawRect(160, 80, 40, -az*50, 0x001F);
      tft.fillRect(160, 80, 40, -az*50, 0x001F);
    } else {
      tft.drawRect(160, 80-az*50, 40, az*50, 0x001F);
      tft.fillRect(160, 80-az*50, 40, az*50, 0x001F);
    }


if(gx < 0){
      tft.drawRect(40, 240, 40,-gx, 0xF81F);
      tft.fillRect(40, 240, 40, -gx, 0xF81F);
    }else{
      tft.drawRect(40, 240-gx, 40,gx, 0xF81F);
      tft.fillRect(40, 240-gx, 40, gx, 0xF81F);
    }

    
    if(gy < 0){
      tft.drawRect(100, 240, 40, -gy, 0x07FF);
      tft.fillRect(100, 240, 40, -gy, 0x07FF);
    }else{
      //tft.drawRect(100, 80, 40, gy, 0x07FF);
      //tft.fillRect(100, 80, 40, gy, 0x07FF);
      //tft.drawLine(100, 80, 40, 80+gy, 0x07FF);
      tft.drawRect(100, 240-gy, 40 , gy,  0x07FF);
      tft.fillRect(100, 240-gy, 40 , gy,  0x07FF);
    }

   
    if (gz < 0) {
      tft.drawRect(160, 240, 40, -gz, 0x001F);
      tft.fillRect(160, 240, 40, -gz, 0x001F);
    } else {
     ...
     tft.drawRect(160, 240-gz, 40 , gz,  0x001F);
     tft.fillRect(160, 240-gz, 40 , gz,  0x001F);
    }
