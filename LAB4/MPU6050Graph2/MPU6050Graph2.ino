...
{  
  ...
  long MappedAx = map(averageAx, -2000, 2000, -80, 80);
  ...
  long  MappedAy = map(averageAy, -2000, 2000, -80, 80);
 ...
 long  MappedAz = map(averageAz, -2000, 2000, -80, 80);
  ...
  long  MappedGx = map(averageGx, -150, 150, -80, 80);
  ...
  long  MappedGy = map(averageGy, -150, 150, -80, 80);
  ...
  long  MappedGz = map(averageGz, -150, 150, -80, 80);

  // send it to the computer as ASCII digits
 

     tft.fillScreen(0xFFFF);
     tft.setCursor(0,0); tft.print("ACCELERATION");
     tft.setCursor(0,160); tft.print("GYRO-RATE");
     tft.setCursor(50,80); tft.print("AX");
     tft.setCursor(110,80); tft.print("AY");
     tft.setCursor(170,80); tft.print("AZ");
     
     tft.setCursor(50,240); tft.print("GX");
     tft.setCursor(110,240); tft.print("GY");
     tft.setCursor(170,240); tft.print("GZ");
      ...
      tft.drawLine(0, 240, 240, 240, 0x0000);
      tft.drawLine(0, 80, 240, 80, 0x0000);
      tft.drawLine(0, 160, 240,160, 0x0000);
  
    //tft.drawRect(30, 240, 20,ax*100, 0x07E0);
    
    
    
    
    if(MappedAx < 0){
      tft.drawRect(40, 80, 40,-MappedAx, 0xF81F);
      tft.fillRect(40, 80, 40,-MappedAx, 0xF81F);
    }else{
      tft.drawRect(40, 80-MappedAx, 40,MappedAx, 0xF81F);
      tft.fillRect(40, 80-MappedAx, 40,MappedAx, 0xF81F);
    }

    if(MappedAy < 0){
      tft.drawRect(100, 80, 40, -MappedAy, 0x07FF);
      tft.fillRect(100, 80, 40, -MappedAy, 0x07FF);
    }else{
      tft.drawRect(100, 80-MappedAy, 40,MappedAy, 0xF81F);
      tft.fillRect(100, 80-MappedAy, 40,MappedAy, 0xF81F);
    }

    
    if (MappedAz < 0) {
      tft.drawRect(160, 80, 40, -MappedAz, 0x001F);
      tft.fillRect(160, 80, 40, -MappedAz, 0x001F);
    } else {
      tft.drawRect(160, 80-MappedAz, 40, MappedAz, 0x001F);
      tft.fillRect(160, 80-MappedAz, 40, MappedAz, 0x001F);
    }


if(MappedGx < 0){
      tft.drawRect(40, 240, 40,-MappedGx, 0xF81F);
      tft.fillRect(40, 240, 40, -MappedGx, 0xF81F);
    }else{
      tft.drawRect(40, 240-MappedGx, 40,MappedGx, 0xF81F);
      tft.fillRect(40, 240-MappedGx, 40, MappedGx, 0xF81F);
    }

    
    if(MappedGy < 0){
      tft.drawRect(100, 240, 40, -MappedGy, 0x07FF);
      tft.fillRect(100, 240, 40, -MappedGy, 0x07FF);
    }else{
      //tft.drawRect(100, 80, 40, gy, 0x07FF);
      //tft.fillRect(100, 80, 40, gy, 0x07FF);
      //tft.drawLine(100, 80, 40, 80+gy, 0x07FF);
      tft.drawRect(100, 240-MappedGy, 40 , MappedGy,  0x07FF);
      tft.fillRect(100, 240-MappedGy, 40 , MappedGy,  0x07FF);
    }

   
    if (MappedGz < 0) {
      tft.drawRect(160, 240, 40, -MappedGz, 0x001F);
      tft.fillRect(160, 240, 40, -MappedGz, 0x001F);
    } else {
     // tft.drawRect(160, 80, 40, gz, 0x0000);
     //tft.fillRect(160, 80, 20, gz, 0x0000);
     // tft.drawLine(160, 80, 160, 80+gz, 0x0000);
     //tft.drawLine(200, 80, 200, 80+gz, 0x0000);
     tft.drawRect(160, 240-MappedGz, 40 , MappedGz,  0x001F);
     tft.fillRect(160, 240-MappedGz, 40 , MappedGz,  0x001F);
    }
    count = millis();
    }
